...
document.addEventListener('DOMContentLoaded', function() {
    const animatedElements = document.querySelectorAll(
        '.project-card, .skill-item, .timeline-item, .education-item, .stat'
    );
...
styleSheet.textContent = lazyLoadingCSS;
document.head.appendChild(styleSheet);

// Social media share functionality
function shareOnSocialMedia(platform, url = window.location.href, text = 'Check out this portfolio') {
    const shareUrls = {
